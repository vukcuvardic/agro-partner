...
<section class="blog">
    ...
    <section class="blog-list">
        <h4>Stariji Postovi</h4>
        <ul>
            <li>
                <a href="#">Drugi post 1</a>
            </li>
            <li>
                <a href="#">Drugi post 2</a>
            </li>
            <li>
                <a href="#">Drugi post 3</a>
            </li>
            <li>
                <a href="#">Drugi post 4</a>
            </li>
            <li>
                <a href="#">Drugi post 5</a>
            </li>
            <li>
                <a href="#">Drugi post 6</a>
            </li>
        </ul>
    </section>
</section><!-- End Blog Main Content -->